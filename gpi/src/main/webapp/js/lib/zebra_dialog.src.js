    ...
    $.Zebra_Dialog = function() {
        ...
        plugin.init = function() {
            ...
            if (plugin.settings.modal) {
                ...
                // set some css properties of the overlay
                    ...
                    'z-index':  5000                                    //  set a high value for z-index
            ...
            // set some css properties of the dialog box
                ...
                'z-index':      5000,                                   //  the z-index must be higher than the overlay's z-index
        ...
        plugin.close = function() {
        	if (plugin.settings.onBeforeClose && typeof plugin.settings.onBeforeClose == 'function'){
                ...
                var returnValue=plugin.settings.onBeforeClose(undefined != arguments[0] ? arguments[0] : '');
